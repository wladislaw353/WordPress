...
?>
<div class="sb_instagram_header <?php echo esc_attr( $size_class ) . esc_attr( $avatar_class ); ?>" style="<?php echo esc_attr( $header_padding . $header_margin ); ?>padding-bottom: 0;">
	<a href="https://www.instagram.com/<?php echo urlencode( $username ); ?>/" target="_blank" rel="noopener nofollow" title="@<?php echo esc_attr( $username ); ?>" class="sbi_header_link">
		<div class="sbi_header_text<?php echo esc_attr( $bio_class ); ?>">
			<h3 <?php SB_Instagram_Display_Elements::print_style( $header_text_color_style ); ?>><?php echo esc_html( $username ); ?></h3>
			<?php if ( $should_show_bio ) : ?>
				<p class="sbi_bio" <?php SB_Instagram_Display_Elements::print_style( $header_text_color_style ); ?>><?php echo str_replace( '&lt;br /&gt;', '<br>', esc_html( nl2br( $bio ) ) ); ?></p>
			<?php endif; ?>
		</div>
		<?php if ( $avatar === '' ) : ?>
		<div class="sbi_header_img">
			<div class="sbi_header_hashtag_icon"><?php echo SB_Instagram_Display_Elements::get_icon( 'newlogo', 'svg' ); ?></div>
		</div>
		<?php else : ?>
		<div class="sbi_header_img" data-avatar-url="<?php echo esc_attr( $avatar ); ?>">
			<div class="sbi_header_img_hover"><?php echo SB_Instagram_Display_Elements::get_icon( 'newlogo', 'svg' ); ?></div>
